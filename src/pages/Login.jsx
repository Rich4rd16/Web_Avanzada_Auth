...
const Login = ({setToken}) => {
  ...
  async function handleSubmit(e){
    ...
    //   alert('Vefifica tu correo por favor')
              ...
              <div className="w-full px-6 py-3">
                <div>
                  <div className="mt-3 text-left sm:mt-5">
                    <div className="inline-flex items-center w-full">
                      <h3 className="text-lg font-bold text-neutral-600 l eading-6 lg:text-5xl">Inicio de Sesión</h3>
                    </div>
                  </div>
                </div>
                <div className="mt-6 space-y-2">
                  ...
                  <div className="flex flex-col mt-4 lg:space-y-2">
                    ...
                    <p>No tienes una cuenta? <Link to='/signup' className="text-rose-700">Resistrate aquí</Link> </p>
                  </div>
                </div>
              </div>
